...
`
    ,
    sg7: `Alex发现黑曜石傀儡用黑曜石禁锢住铁匠,并派出怪物向自己发动了攻击,随着激烈的战斗打响,Alex最后成功解救了铁匠.并且二人在被怪物吞没前敲破了黑曜石墙,发现了一条新的路
.
二人继续向前行走,通过一条新的狭窄的路继续前进,来到了洞穴水层,这里依旧是一片湖泊,但是地表布满黑色的脉络,一道道音波此起彼伏.
Alex: 没想到这矿洞下面别有一番洞天
...
`
    ,
    sg8: `making, please wait the next update`,
